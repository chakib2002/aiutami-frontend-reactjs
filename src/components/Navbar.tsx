  ...
  return (
    ...
    <div className='bg-primary col-span-3'>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" 
        ...
        <div className='text-secondary text-base hidden lg:inline cursor-default'>{firstname} {lastname}</div>
        <img src={link ? link : 'https://imgs.search.brave.com/vLBQF6u3LXw69YDbtMDqv8K0uUxyGpga5L_8nN-ip7Y/rs:fit:1200:1200:1/g:ce/aHR0cHM6Ly90aGVw/b3dlcm9mdGhlZHJl/YW0ub3JnL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDE1LzA5L2dl/bmVyaWMtcHJvZmls/ZS1waWN0dXJlLTEy/MDB4MTIwMC5qcGc'}
         alt=''
